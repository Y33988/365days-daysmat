...
import com.remcalendar.data.dao.AnniversaryDao_Impl;
import com.remcalendar.data.dao.EventDao;
import com.remcalendar.data.dao.EventDao_Impl;
...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `events` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `title` TEXT NOT NULL, `date` INTEGER NOT NULL, `time` INTEGER, `location` TEXT, `description` TEXT, `category` TEXT NOT NULL, `color` INTEGER NOT NULL, `isAllDay` INTEGER NOT NULL, `reminderMinutes` INTEGER, `repeatRule` TEXT, `createdAt` INTEGER NOT NULL)");
        db.execSQL("CREATE TABLE IF NOT EXISTS `anniversaries` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `title` TEXT NOT NULL, `date` INTEGER NOT NULL, `category` TEXT NOT NULL, `icon` TEXT NOT NULL, `color` INTEGER NOT NULL, `isTop` INTEGER NOT NULL, `repeatInterval` TEXT NOT NULL, `isLunar` INTEGER NOT NULL, `createdAt` INTEGER NOT NULL)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '6489b6ad36eafa0f5ba6fbcfc82082dd')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsEvents.put("time", new TableInfo.Column("time", "INTEGER", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsEvents.put("repeatRule", new TableInfo.Column("repeatRule", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsEvents.put("createdAt", new TableInfo.Column("createdAt", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoEvents.equals(_existingEvents)) {
          return new RoomOpenHelper.ValidationResult(false, "events(com.remcalendar.data.model.Event).\n"
                  + " Expected:\n" + _infoEvents + "\n"
                  + " Found:\n" + _existingEvents);
        }
        final HashMap<String, TableInfo.Column> _columnsAnniversaries = new HashMap<String, TableInfo.Column>(10);
        _columnsAnniversaries.put("id", new TableInfo.Column("id", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsAnniversaries.put("title", new TableInfo.Column("title", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsAnniversaries.put("date", new TableInfo.Column("date", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsAnniversaries.put("category", new TableInfo.Column("category", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsAnniversaries.put("icon", new TableInfo.Column("icon", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsAnniversaries.put("color", new TableInfo.Column("color", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsAnniversaries.put("isTop", new TableInfo.Column("isTop", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsAnniversaries.put("repeatInterval", new TableInfo.Column("repeatInterval", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsAnniversaries.put("isLunar", new TableInfo.Column("isLunar", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsAnniversaries.put("createdAt", new TableInfo.Column("createdAt", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoAnniversaries.equals(_existingAnniversaries)) {
          return new RoomOpenHelper.ValidationResult(false, "anniversaries(com.remcalendar.data.model.Anniversary).\n"
                  + " Expected:\n" + _infoAnniversaries + "\n"
                  + " Found:\n" + _existingAnniversaries);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "6489b6ad36eafa0f5ba6fbcfc82082dd", "94cc5847b386688e815b883ba50695c6");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "events","anniversaries");
  }
